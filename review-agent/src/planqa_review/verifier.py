...
# Prose citation without a DOC-XXX code, e.g. "「5G 가족결합 운영전략서」 2-4 '과도한 데이터
# 이전 방지 원칙'을 따른다" or "...2-2 '하위 재량 허용 범위'에 해당하는 경우" — same 문서명+
# 섹션 reference 룰북 §3 describes, phrased as a sentence instead of the "(DOC-XXX) 참고"
# shorthand the original regex assumed (found via "예외조건 data" QA-dataset rows, none of
# which use a DOC-XXX code — planqa-agent PR #32, 2026-08-12).
