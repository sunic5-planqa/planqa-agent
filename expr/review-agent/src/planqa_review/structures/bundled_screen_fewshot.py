...
# bundled_screen_fewshot — bundled_screen(콜통합×룰전부×2단계)과 판정 방식·청킹은 동일하게
# 유지하고, screen/confirm 양쪽 프롬프트 모두에서 룰 텍스트를 빼고 fewshot_bank.py의
# 예시만 준다.
...
def review_document(
    ...
    """bundled_screen_fewshot — bundled_screen과 판정 방식·청킹은 동일(2단계, 문단형)하지만
    screen/confirm 양쪽 프롬프트 모두에서 룰 텍스트를 빼고 fewshot_bank.py의 예시만 준다."""
